...
/*   Updated: 2022/11/19 14:41:01 by kipark           ###   ########seoul.kr  */
/*                                                                            */
/* ************************************************************************** */
															...
															t_data *game_view)
{
	...
	minimap->img = my_mlx_new_image(game->mlx, game->map_width * MINIMAP_SIZE, \
	...
	game_view->img = my_mlx_new_image(game->mlx, game->width, game->height);
